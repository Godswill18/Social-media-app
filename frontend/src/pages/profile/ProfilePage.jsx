...
const ProfilePage = () => {
	...
	// const isLoading = false;
		const {data: authUser} = useQuery({queryKey: ["authUser"],queryFn: async () => {
				try {
	...
	// console.log("Logged in user:", loggedinUser.data.username);
	...
	const {isUpdatingProfile, updateProfile} = useUpdateUserProfile(coverImg, profileImg)
						...
						<>
							...
							<div className='flex flex-col gap-4 mt-14 px-4'>
								...
								<div className='flex gap-1 items-center'>
									...
									<a
										href={
										user.links.startsWith('http://') || user.links.startsWith('https://')
											? user.links
											: `https://${user.links}`
										}
										target='_blank'
